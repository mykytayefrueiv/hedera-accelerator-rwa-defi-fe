import { type CopeData, copeIpfsData } from "@/consts/cope";
...
export async function fetchCopeData(
	ipfsHash: string,
): Promise<CopeData | null> {
...
export async function updateCopeData(
	ipfsHash: string,
	newData: Partial<CopeData>,
): Promise<boolean> {
