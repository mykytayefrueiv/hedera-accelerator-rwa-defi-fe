...
import { AddAllocationRequest } from "@/types/erc3643/types";
            ...
            >
                {({ setFieldValue, values }) => (
                    <Form className="space-y-4">
                        ...
                        <div>
                            <label className="block text-md font-semibold text-purple-400">Select Token Asset (Auto Compounder Token)</label>
                            <Select
                                styles={colourStyles}
                                className="mt-2"
                                placeholder="e.g. 0x"
