...
function render(proposal: { proposal: ProposalTypes }) {
   // @ts-ignore
...
export function Proposal({ proposal }: { proposal: ProposalTypes }) {
   return (
      <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-sm p-6">
         <div className="grid grid-cols-6 w-full">
            ...
            <div className="col-span-1">
               <button
                  type="button"
                  className="bg-green-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded-sm outline-hidden focus:outline-hidden mr-1 mb-1 ease-linear transition-all duration-150"
               >
                  Yes
               </button>
               &nbsp;
               <button
                  type="button"
                  className="bg-red-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded-sm outline-hidden focus:outline-hidden mr-1 mb-1 ease-linear transition-all duration-150"
               >
                  No
               </button>
            </div>
