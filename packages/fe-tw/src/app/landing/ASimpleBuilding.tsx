   ...
   return (
      <div className="flex flex-wrap items-center mt-32 text-slate-700">
         <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
            ...
            <h3 className="text-3xl mb-2 font-semibold leading-normal">Join us on the journey</h3>
            <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-slate-600">
               We've decided to not present the finished product, but to go through the overall
               journey with you, explaining some of the thought processes, standards, and choices we
               made along the way
            </p>
         ...
         <div className="w-full md:w-4/12 px-4 mr-auto ml-auto">
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-xs rounded-3xl bg-white transition-all duration-300 hover:ring-2 hover:ring-gray-100 hover:shadow-md">
               <img
                  ...
                  className="w-full align-middle rounded-t-3xl"
               />
