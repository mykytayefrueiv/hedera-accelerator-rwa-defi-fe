      ...
      <section className="pb-20 relative block bg-white">
         ...
         >
            ...
            >
               ...
               <polygon className="text-white fill-current" points="2560 0 2560 2560 0 100" />
            </svg>
         </div>
            ...
            <div className="items-center flex flex-wrap">
               ...
               <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
                  <div className="md:pr-12">
                     ...
                     <h3 className="text-3xl font-semibold text-black">Let's go further</h3>
                     <p className="mt-4 text-lg leading-relaxed text-gray-700">
                        How do we integrate different compatibility techniques that DeFi has
                        introduced to increase the attractiveness of our REIT
                     </p>
