...
import { BuildingMintAndAddLiquidity } from "@/components/Buildings/BuildingLiquidity";
...
export default function LiquidityPage({ params }: Props) {
  ...
  return (
    <div className="p-4">
      ...
      <BuildingMintAndAddLiquidity buildingAddress={building.address as `0x${string}`} />
    </div>
  );
}
